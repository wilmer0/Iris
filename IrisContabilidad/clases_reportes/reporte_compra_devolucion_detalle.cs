...
{
    public class reporte_compra_devolucion_detalle
    {
        ...
        public reporte_compra_devolucion_detalle()
        {
            
        }
        public reporte_compra_devolucion_detalle(compraDevolucionDetalle devolucionDetalle)
        {
