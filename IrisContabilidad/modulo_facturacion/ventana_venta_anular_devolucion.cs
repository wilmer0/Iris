...
{
    public partial class ventana_venta_anular_devolucion : formBase
    {
        //objetos
        private venta venta;
        ...
        public ventana_venta_anular_devolucion(bool mantenimiento=false)
        {
            InitializeComponent();
        ...
        private void ventana_venta_anular_devolucion_Load(object sender, EventArgs e)
        {
        ...
        public void filtrar()
        {
            try
            {
                ...
                {
                    listaVentaDevolucion = listaVentaDevolucion.FindAll(x => x.codigo.ToString().ToLower().Contains(nombreText.Text.ToLower()));
                }
                //por fecha
                ...
                {
                    listaVentaDevolucion = listaVentaDevolucion.FindAll(x => x.codigo_venta.ToString().ToLower().Contains(nombreText.Text.ToLower()));
                }
                //Cliente
                if (radioButtonFecha.Checked == true)
                {
