        ...
        public bool modificarCuadreCaja(cuadre_caja cuadreCaja)
        {
            try
            {
                ...
                try
                {
                    ...
                    sql = "insert into cuadre_caja_detalles(codigo_cuadre,monto_efectivo,monto_tarjeta,monto_cheque,monto_deposito,monto_egreso,monto_ingreso,monto_sobrante,monto_faltante,monto_notas_debito,monto_notas_credito,monto_cotizacion,monto_pedido,monto_venta_contado,monto_efectivo_apertura_caja,monto_pagos_efectivo,monto_efectivo_recibido_cajero) values('" + cuadreCaja.cuadre_caja_detalle.codigo_cuadre_caja + "','" + cuadreCaja.cuadre_caja_detalle.monto_efectivo + "','" + cuadreCaja.cuadre_caja_detalle.monto_tarjeta + "','" + cuadreCaja.cuadre_caja_detalle.monto_cheque + "','" + cuadreCaja.cuadre_caja_detalle.monto_deposito + "','" + cuadreCaja.cuadre_caja_detalle.monto_egreso + "','" + cuadreCaja.cuadre_caja_detalle.monto_ingreso + "','" + cuadreCaja.cuadre_caja_detalle.monto_sobrante + "','" + cuadreCaja.cuadre_caja_detalle.monto_faltante + "','" + cuadreCaja.cuadre_caja_detalle.montoNotasDebito + "','" + cuadreCaja.cuadre_caja_detalle.montoNotasCredito + "','" + cuadreCaja.cuadre_caja_detalle.monto_cotizacion + "','" + cuadreCaja.cuadre_caja_detalle.monto_pedido + "','" + cuadreCaja.cuadre_caja_detalle.montoFacturaContado + "','" + cuadreCaja.cuadre_caja_detalle.montoEfectivoAperturaCaja + "','" + cuadreCaja.cuadre_caja_detalle.montoPagoEfectivo + "','"+cuadreCaja.cuadre_caja_detalle.montoEfectivoIngresadoCajero+"');";
