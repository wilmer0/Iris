...
namespace IrisContabilidad.modelos
{
     class modeloEmpleado
    {
        ...
        private empleado empleado;
         ...
         Boolean validarLogin(string usuario,string clave)
        {
            try
            {
         ...
         List<string> GetListaModulosByEmpleado(empleado empleado)
        {
            try
            {
                //listas
                ...
                string sql = "";
                sql = "SELECT id_ventana_sistema FROM empleado_accesos_ventanas ev where  ev.id_empleado ='"+empleado.codigo+"'";
                DataSet ds = utilidades.ejecutarcomando_mysql(sql);
         ...
         List<empleado> getListaCompleta()
        {
            try
            {
         ...
         empleado getEmpleadoByLogin(empleado e)
        {
            try
            {
                empleado empleado;
